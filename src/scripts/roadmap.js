...
document.addEventListener("astro:page-load", () => {
        ...
        || href === "https://paul-mallet.netlify.app/about/")
    {
        ...
        const roadObj = {
            ...
            btn_nxt: all_btn_nxt,
            btn_prv: all_btn_prv,
            animation_nxt: ["anim1", "anim2", "anim3", "anim4", "anim5", "anim6", "anim7", "anim8"],
            animation_prv: ["anim9", "anim10", "anim11", "anim12", "anim13", "anim14", "anim15", "anim16"],
        }
